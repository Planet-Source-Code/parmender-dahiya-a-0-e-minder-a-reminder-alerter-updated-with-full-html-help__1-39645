...
Begin VB.Form ShowAll 
   ...
   Caption         =   "E - Minder - All Reminders"
   ClientHeight    =   6495
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8400
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ShowAll.frx":0452
            Key             =   "call"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ShowAll.frx":08A4
            Key             =   "mail"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ShowAll.frx":0CF6
            Key             =   "misc"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "ShowAll.frx":1148
            Key             =   "meeting"
         EndProperty
      EndProperty
   End
...
If rs.RecordCount = 0 Then ' Read all record if record count not zero
    MsgBox "No records are there in the database to delete.", vbOKOnly + vbInformation, "E - Minder - No records"
    Exit Sub
End If

If (MsgBox("This will delete all the 'Done' entries." & vbCrLf & _
    "Continue ?", vbYesNo + vbQuestion, "E - Minder - Warning")) = vbYes Then
...
If findrecord = False Then ' Call findrecord function
    MsgBox "Record is not found in the database.", vbOKOnly + vbInformation, "E - Minder - Error"
    Exit Sub
Else ' if record is found then update the record with new date and time
    ...
    rs.Update
    MsgBox "Both time and date successfully changed.", vbOKOnly + vbInformation, "E - Minder"
    rmlist.ListItems.Clear
...
If rmlist.ListItems.Count = 0 Then
    MsgBox "No entry to mark as 'Done'", vbOKOnly + vbCritical, "E - Minder - Error"
    Exit Sub
End If

If rmlist.SelectedItem.SubItems(5) = "Done" Then ' Check if alraedy "Done"
    MsgBox "Status of this entry is already marked as 'Done'", vbOKOnly + vbInformation, "E - Minder - Error"
    Exit Sub
End If
                                                  'Confirm change
If (MsgBox("Are you sure to mark this entry as 'Done' ?", _
    vbYesNo + vbQuestion, "E - Minder - Confirm")) = vbNo Then Exit Sub
...
Else        ' if found then update the record
    ...
    rs("alm_done") = True
    rs.Update
    MsgBox "Successfully marked as 'Done'.", vbOKOnly + vbInformation, "E - Minder"
    rmlist.ListItems.Clear
    fillwindow
End If
End Sub
...
If rmlist.ListItems.Count = 0 Then
    MsgBox "No entry to mark as 'Pending'", vbOKOnly + vbCritical, "E - Minder - Error"
    Exit Sub
End If

If rmlist.SelectedItem.SubItems(5) = "Pending" Then ' Check if already pending
    MsgBox "Status of this entry is already marked as 'Pending'", vbOKOnly + vbCritical, "E - Minder - Error"
    Exit Sub
End If
...
Else                       ' if found then update record
    ...
    rs("alm_done") = False
    rs.Update
    MsgBox "Successfully marked as 'Pending'.", vbOKOnly + vbInformation, "E - Minder"
    rmlist.ListItems.Clear
    fillwindow
End If
...
Dim temp2 As String
If rmlist.ListItems.Count = 0 Then
    MsgBox "No entry to change date and time.", vbOKOnly + vbCritical, "E - Minder - Error"
    Exit Sub
End If
                                                ' Confirm change
...
If findrecord = False Then ' Call findrecord function
    MsgBox "Record is not found in the database.", vbOKOnly + vbInformation, "E - Minder - Error"
    Exit Sub
Else ' if record is found then populate existing date and time in the input boxes to change
    showbuttons ' show date and time text boxes and buttons
    temp1 = rs("alm_month")
    temp2 = rs("alm_day")
    If Len(temp2) = 1 Then temp2 = "0" & temp2
    If Len(temp1) = 1 Then temp1 = "0" & temp1
    aldate.Mask = temp1 & "/" & temp2 & "/" & rs("alm_year")
    temp1 = rs("alm_hour")
    temp2 = rs("alm_minute")
    If Len(temp1) = 1 Then temp1 = "0" & temp1
    If Len(temp2) = 1 Then temp2 = "0" & temp2
    altime.Mask = temp1 & ":" & temp2
End If
End Sub
