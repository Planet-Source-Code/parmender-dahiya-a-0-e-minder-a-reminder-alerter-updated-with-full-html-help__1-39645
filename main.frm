...
'On Error GoTo hlperr
ShowHelpFile (App.Path & "\help.chm")
If hwndHelp = 0 Then
MsgBox "An error has occurred while opening the help file for E - Minder." & vbCrLf & _
"Or the help file 'Help.chm' not found in the current path." & vbCrLf & _
"Please make sure that the help file 'Help.chm' is there is the current path.", vbOKOnly + vbCritical, "E - Minder - Error"
End If
End Sub
...
'save to database
If (MsgBox("Save this reminder entry ?", vbYesNo + vbQuestion, "E - Minder - Confirm")) = vbYes Then
savealarm (rmcode)
Call cmdclear_Click
End If
...
MsgBox "No reminders are there in the database to show.", vbOKOnly + vbInformation, "E - Minder - No records"
Exit Sub
End If
ShowAll.Show
Me.Hide
