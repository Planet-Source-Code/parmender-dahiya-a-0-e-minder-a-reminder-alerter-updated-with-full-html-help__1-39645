...
Set db = ws.OpenDatabase(App.Path & "\EMinder.mdb")
Set rs = db.OpenRecordset("EMinderTable", dbOpenTable)
rs.Index = "alm_done"
Exit Function

error:
MsgBox "Either database 'EMinder.mdb' or a table 'EMinderTable' in this database or both missing." _
...
vbCritical + vbOKOnly, "E - Minder - Database Error"
MsgBox "E - Minder can not be started.", vbCritical + vbOKOnly, "E - Minder - Opening Error"
End
End Function
...
vbInformation + vbOKOnly, "E - Minder - Reminder Added"
Exit Function
...
NotifyIcon.szTip = "E - Minder" & vbCrLf & "Left Click to show." & vbCrLf & "Right Click to Close" & Chr$(0)
